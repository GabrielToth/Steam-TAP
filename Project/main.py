...
driver.find_element_by_xpath('//div[@id="searchResultsTable"]//div[@id="searchResultsRows"]//div[@class="market_listing_table_header"]//div[@class="market_sortable_column"]').click()

element = driver.find_element_by_xpath('//div[@id="searchResultsTable"]//div[@id="searchResultsRows"]')
html_content = element.get_attribute('outerHMTML')
print(element)
print(html_content)
#element = driver.find_element_by_xpath('//div[@class="market_listing_row market_recent_listing_row market_listing_searchresult"]//div[@class="market_listing_price_listings_block"]//div[@class="market_listing_right_cell market_listing_their_price"]//span[@class="market_table_value normal_price"]//span[@class="sale_price"]')
